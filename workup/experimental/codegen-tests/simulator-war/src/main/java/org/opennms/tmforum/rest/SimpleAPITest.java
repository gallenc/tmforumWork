...
public class SimpleAPITest {
     ...
     * 
     * simple query
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/1/?fields=id&offset=5&limit=7
     * 
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/1/?fields=description,status&creationDate.gt=2013-04-20&status=acknowledged
     * status=acknowledged;status=rejected
     * status=acknowledged&status=rejected
     * status=acknowledged,rejected
     * 
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/1/?fields=description,status&creationDate.gt=2013-04-20&status=acknowledged,rejected
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/1/?fields=description,status&creationDate.gt=2013-04-20&status=acknowledged&status=rejected
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/1/?fields=description,status&creationDate.gt=2013-04-20&status=acknowledged;status=rejected
     * 
     * sort
...
Sort-Field: The field to sort on.
     * example
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/1/?fields=id&offset=5&limit=7&sort=,+,creationDate,statusChangeDate,note.date
     ...
     * 
     * Test String
     * http://localhost:8080/tmf656-spm-simulator-war/tmf-api/serviceProblemManagement/v3/simpleApiTestService/?fields=description,status&creationDate.gt=2013-04-20&status=acknowledged&status=rejected&name=hello&dateTime.gt=2013-04-20&dateTime.lte=2017-04-20
     * 
     * 
     */
