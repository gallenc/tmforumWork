...
Sort-Field: The field to sort on.
    ...
    public Response retrieveTest( @QueryParam("fields") String fields,
        ...
        try {
           String responseString="GET simpleApiTestService/ called fields=" + fields+"${symbol_escape}n";
          
           String requestUri=uriInfo.getRequestUri().toString();
           LOG.debug("path=" + requestUri);
           
           responseString+="path=" + requestUri+"${symbol_escape}n";
           responseString+="parameter multi value map:"+"${symbol_escape}n";

           
           MultivaluedMap<String, String> mvMap = uriInfo.getQueryParameters();
           for(String param: mvMap.keySet()) {
               responseString+="   param: " + param+"${symbol_escape}n";
               List<String> values = mvMap.get(param);
               for(String value: values) {
                   responseString+="      value: " + value+"${symbol_escape}n";
               }
           }
