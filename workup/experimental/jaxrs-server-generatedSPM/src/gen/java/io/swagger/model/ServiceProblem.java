...
public class ServiceProblem   {
  ...
  public ServiceProblem resolutionDate(Date resolutionDate) {
  ...
  public ServiceProblem statusChangeDate(Date statusChangeDate) {
  ...
  public ServiceProblem timeChanged(Date timeChanged) {
  ...
  public ServiceProblem timeRaised(Date timeRaised) {
